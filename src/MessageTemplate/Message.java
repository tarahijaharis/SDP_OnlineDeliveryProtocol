...
public class Message implements IMessage, Cloneable {
    public static class Types{
        ...
        public static int LOGIN_SUCCESSFUL_ADMIN = 8;
        public static int LOGIN_SUCCESSFUL_USER = 9;
        public static int ASKING_FOR_ITEMS = 10;
        public static int SENDING_ITEMS = 11;
